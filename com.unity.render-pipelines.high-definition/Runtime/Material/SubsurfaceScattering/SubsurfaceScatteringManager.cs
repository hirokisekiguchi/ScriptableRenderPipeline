...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    public class SubsurfaceScatteringManager
    {
        ...
        public void PushGlobalParams(HDCamera hdCamera, CommandBuffer cmd, DiffusionProfileSettings sssParameters)
        {
            ...
            cmd.SetGlobalInt(HDShaderIDs._EnableSubsurfaceScattering, hdCamera.frameSettings.subsurfaceScattering ? 1 : 0);
            unsafe
            {
            ...
            cmd.SetGlobalVectorArray(HDShaderIDs._TransmissionTintsAndFresnel0, hdCamera.frameSettings.transmission ? sssParameters.transmissionTintsAndFresnel0 : sssParameters.disabledTransmissionTintsAndFresnel0);
        ...
        {
            if (sssParameters == null || !hdCamera.frameSettings.subsurfaceScattering)
                return;
            ...
            using (new ProfilingSample(cmd, "Subsurface Scattering", CustomSamplerId.SubsurfaceScattering.GetSampler()))
            {
                ...
                if (NeedTemporarySubsurfaceBuffer() || hdCamera.frameSettings.msaa)
                {
                ...
                int sssKernel = hdCamera.frameSettings.msaa ? m_SubsurfaceScatteringKernelMSAA : m_SubsurfaceScatteringKernel;
